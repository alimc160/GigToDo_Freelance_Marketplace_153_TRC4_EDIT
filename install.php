    ...
    <div class="card rounded-0 mb-4">
      <div class="card-body">
        <form method="post" enctype="multipart/form-data">
          ...
          <h3>Welcome</h3>
          <hr>
          <p>Welcome to the Nulled installer
          ...
          <div class="form-group row ">
              ...
              <div class="col-md-8">
                  <input type="text" name="db_pass" value="root" class="form-control">
              </div>
          </div>
          <!-- form-group row Ends -->
          ...
          <div class="form-group row ">
              ...
              <div class="col-md-8">
                  <input type="text" name="db_name" value="gigtodo_nulled" class="form-control" required>
              </div>
          </div>
          <!-- form-group row Ends -->
          ...
          <div class="form-group row ">
              ...
              <div class="col-md-4">
                  <button type="submit" name="install" class="btn btn-success form-control">Next <i class="fa fa-arrow-right"></i></button>
              </div>
          </div>
          <!-- form-group row Ends -->
        </form>
...
if(isset($_POST["install"])){
  ...
  // CONFIGS
  $filename ='install_db_nulled.sql';
