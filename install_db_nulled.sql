...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 07, 2020 at 07:56 PM
...
--
-- Creation: Dec 07, 2020 at 06:52 PM
--
...
(1, '', '', '', '', 'black.png', '', 'Albania', 'PHP Framework', '', 0);
...
CREATE TABLE IF NOT EXISTS `cats_meta` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `cat_id` int(10) NOT NULL,
  `language_id` int(10) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `child_cats_meta` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `child_id` int(10) NOT NULL,
  `child_parent_id` int(10) NOT NULL,
  `language_id` int(10) NOT NULL,
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6825 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `contact_support_meta` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `language_id` int(10) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `currency_converter_settings` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `dusupay_orders` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
(1, '', 1, '', 'favicon.ico', 'image', '', 'logo1.png', 1, 'mobile-logo.png', 'logo1.png', 0, 0, 0, 0, 'watermark.png', '', '#2ca35b', '#2ca35b', '#2ca35b', '', '', '', '', '', '', 'Europe/Tirane', 1, 0, '', '', '', 'no', '', '', '', '', '', 85, 10, 95, 25, 100, 50, 'yes', 0, 0, 'yes', '', 0, 'yes', 'yes', 'yes', 'yes', 1, '22', 'left', 'us', 'no', 0, 2, 1, '', 0, 0, '');
...
CREATE TABLE IF NOT EXISTS `hide_seller_messages` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
(1, 1, 'TRC4 Albania', 'Services On Demand');
...
CREATE TABLE IF NOT EXISTS `home_section_slider` (
...
CREATE TABLE IF NOT EXISTS `inbox_sellers` (
...
CREATE TABLE IF NOT EXISTS `instant_deliveries` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `proposal_id` int(10) NOT NULL,
  `enable` int(10) NOT NULL,
  `message` text COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `languages_relation` (
...
CREATE TABLE IF NOT EXISTS `messages_offers` (
...
CREATE TABLE IF NOT EXISTS `my_buyers` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `seller_id` int(10) NOT NULL,
  `buyer_id` int(10) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `my_sellers` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `buyer_id` int(10) NOT NULL,
  `seller_id` int(10) NOT NULL,
  `completed_orders` int(10) NOT NULL,
...
(1, 5, 12, 1, 5, 10, 1, 1, 'fixed', 2, 'no', '', '', '', '', 'on', 1, 'no', '', '', '', '', 'no', 'on', '', '', '', '', '', '', '', '', 'no', '', 'EUR', 'off', 'no', '', '', 'sender', '', '', '', 'no', '', '', 0, '', '', 0);
...
CREATE TABLE IF NOT EXISTS `post_categories_meta` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `proposals_extras` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `proposal_id` int(10) NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `proposals_faq` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `proposal_modifications` (
...
CREATE TABLE IF NOT EXISTS `proposal_referrals` (
...
CREATE TABLE IF NOT EXISTS `recent_proposals` (
...
CREATE TABLE IF NOT EXISTS `section_boxes` (
...
CREATE TABLE IF NOT EXISTS `seller_levels_meta` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `language_id` int(10) NOT NULL,
  `level_id` int(10) NOT NULL,
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `seller_type_status` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `seller_id` int(10) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `send_offers` (
  `offer_id` int(10) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `site_currencies` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `skills_relation` (
  `relation_id` int(10) NOT NULL AUTO_INCREMENT,
  `seller_id` int(10) NOT NULL,
...
(27, 1, '', '', 'cover-boy.png', 'https://kodi.al/', 0),
(32, 1, '', '', 'art-artist-canvas-374054.jpg', 'http://albdroid.al/', 0),
(33, 1, '', '', 'art-dark-ethnic-1038041.jpg', 'https://demo.kodi.al/', 0);
...
CREATE TABLE IF NOT EXISTS `temp_extras` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `reference_no` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `buyer_id` int(10) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `top_proposals` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `proposal_id` int(10) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
