    ...
    <div class="card mb-5"><!--- card mb-5 Starts --->
      ...
      <div class="card-body p-0"><!--- card-body Starts --->
        <form action="" method="post" enctype="multipart/form-data"><!--- form Starts --->
          ...
          <label class="col-md-3 control-label"><b>License Key:</b> <?= $purchase_code; ?></label>

          </div><!--- form-group row Ends --->
          <hr class="mt-0 mb-2">
          <div class="form-group row mb-0 pl-3 pr-3 pb-2 pt-2"><!--- form-group row Starts --->
          <label class="col-md-3 control-label"><b>License Type:</b> <?= $license_type; ?></label>

          </div><!--- form-group row Ends --->
          <hr class="mt-0 mb-2">
          <div class="form-group row mb-0 pl-3 pr-3 pb-2 pt-2"><!--- form-group row Starts --->
          <label class="col-md-3 control-label"><b>License Domain: <a href="<?= $website; ?>" target="_blank" style="color: green;"><?= $website; ?></a><b></label>
